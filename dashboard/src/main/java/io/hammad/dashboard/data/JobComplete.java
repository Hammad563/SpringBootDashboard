package io.hammad.dashboard.data;
...
@Component
public class JobComplete extends JobExecutionListenerSupport {

  private static final Logger log = LoggerFactory.getLogger(JobComplete.class);

  private final EntityManager em;

  @Autowired
  public JobComplete(EntityManager em) {
    this.em = em;
  }
